// lib/seoConfig.js
// ToolVoid - Complete SEO Configuration for all 21 tools + static pages
...
export const toolsSEO = {
  ...
  'base64': {
    title: 'Base64 Encoder & Decoder Online — Free | ToolVoid',
  ...
  'domain': {
    title: 'Domain Checker — Check Domain Availability & WHOIS | ToolVoid',
  ...
  'emi': {
    title: 'EMI Calculator Online — Loan & Interest Calculator | ToolVoid',
  ...
  'hashtag': {
    title: 'Hashtag Generator — AI-Powered Free Hashtags | ToolVoid',
  ...
  'image-generator': {
    title: 'AI Image Generator — Free Text to Image Online | ToolVoid',
  ...
  'image-tools': {
    title: 'Image Tools — Resize, Convert, Compress & Remove BG | ToolVoid',
  ...
  'invoice': {
    title: 'Free Invoice Generator — Create & Download PDF Invoice | ToolVoid',
  ...
  'json': {
    title: 'JSON Formatter & Validator Online — Free | ToolVoid',
  ...
  'keyword': {
    title: 'SEO Keyword Generator — Free Keyword Research Tool | ToolVoid',
  ...
  'loan': {
    title: 'Loan Calculator — Calculate Interest & Monthly Payment | ToolVoid',
  ...
  'passport': {
    title: 'Passport Photo Maker — Free Online Passport Size Photo | ToolVoid',
  ...
  'password': {
    title: 'Password Generator — Strong & Secure Random Passwords | ToolVoid',
  ...
  'pdf': {
    title: 'Free PDF Tools — Convert, Merge, Split, Compress PDF | ToolVoid',
  ...
  'qr': {
    title: 'QR Code Generator — Free Custom QR Codes | ToolVoid',
  ...
  'resume': {
    title: 'Free Resume Builder — ATS-Friendly Resume Templates | ToolVoid',
  ...
  'story': {
    title: 'AI Script Generator — Free Timed Video Scripts Online | ToolVoid',
    description: 'Generate timed AI video scripts with narration and visual directions. Choose genre, duration, pace and topic. Perfect for YouTube, shorts, and video production.',
    keywords: ['ai script generator', 'video script writer', 'ai script writer', 'video narration generator', 'free script generator ai', 'timed script maker'],
    ogImage: `${BASE_URL}/og/story.png`,
    schema: 'WebApplication',
  },

  'tts': {
    title: 'Text to Speech — Free Online TTS Voice Generator | ToolVoid',
  ...
  'unit': {
    title: 'Unit Converter — Convert Length, Weight, Temperature & More | ToolVoid',
  ...
  'video': {
    title: 'Online Video Tools — Trim, Convert & Compress Video Free | ToolVoid',
  ...
  'word-counter': {
    title: 'Word Counter & Text Analyzer — Free Online | ToolVoid',
  ...
  'tools': {
    title: 'All Free Online Tools — 20+ Web Tools | ToolVoid',
    description: 'ToolVoid offers 20+ free online tools — PDF tools, resume builder, AI image generator, QR code maker, calculators, and more. No signup required.',
    keywords: ['free online tools', 'web tools', 'toolvoid', 'pdf tools', 'ai tools free', 'online utilities'],
    ogImage: `${BASE_URL}/og/tools.png`,
    schema: 'WebSite',
  },

  'about': {
    title: 'About ToolVoid — Free Tools Built for Everyone',
    description: 'Learn about ToolVoid — a collection of 20+ free, privacy-friendly online tools for everyday use. No account needed, no data stored.',
    keywords: ['about toolvoid', 'toolvoid info'],
    ogImage: `${BASE_URL}/og-default.png`,
    schema: 'WebPage',
  },

  'privacy': {
    title: 'Privacy Policy | ToolVoid',
    description: 'ToolVoid privacy policy. We value your privacy and are transparent about analytics, cookies, ads, and third-party AI processing.',
    keywords: ['toolvoid privacy policy'],
    ogImage: `${BASE_URL}/og-default.png`,
    schema: 'WebPage',
  },

  'terms': {
    title: 'Terms of Service | ToolVoid',
    description: 'Terms and conditions for using ToolVoid and its free online tools.',
    keywords: ['toolvoid terms of service'],
    ogImage: `${BASE_URL}/og-default.png`,
    schema: 'WebPage',
  },
}
